...
namespace Asp.Net_Core_5_Demo.Data
{
    public partial class AdventureDbContext : DbContext
    {
		...
		//                optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=AdventureWorks2014;Integrated Security=True");
		//            }
		//        }
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ProductReview>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.ProductId, e.ReviewerName }, "IX_ProductReview_ProductID_Name")
                    .IncludeProperties(new[] { "Comments" });
